...
class DemoData {
        ...
        private static gameData = [
                [name      : 'Gloomhaven', minPlayers: 1, maxPlayers: 4, averageDuration: 120, rating: 9.2,
                 thematic  : true,
                 strategy  : true,
                ...
                [name      : 'Star Wars: Rebellion', minPlayers: 2, maxPlayers: 4, averageDuration: 210, rating: 8.0,
                 thematic  : true,
                ...
                [name      : 'Power Grid', minPlayers: 2, maxPlayers: 6, averageDuration: 120, rating: 6.8,
                 strategy  : true,
                 categories: ['Economic', 'Industry/Manufacturing'],
                 mechanics : ['Auction/Bidding', 'Route/Network Building']
                ],
                [name      : 'Dominion', minPlayers: 2, maxPlayers: 4, averageDuration: 30, rating: 6.4,
                 strategy  : true,
                 categories: ['Card Game', 'Medieval'],
                 mechanics : ['Card Drafting', 'Deck/Pool Building', 'Hand Management']
                ],
                [name      : 'La Granja', minPlayers: 1, maxPlayers: 4, averageDuration: 105, rating: 6.6,
                 strategy  : true,
                ...
                [name      : 'The Princes of Florence', minPlayers: 2, maxPlayers: 5, averageDuration: 90, rating: 6.2,
                 strategy  : true,
                 categories: ['City Building', 'Renaissance'],
                 mechanics : ['Auction/Bidding', 'Tile Placement']
                ],
                [name      : 'Small World', minPlayers: 2, maxPlayers: 5, averageDuration: 60, rating: 5.8,
                 family    : true,
                 strategy  : true,
                 categories: ['Fantasy', 'Fighting', 'Territory Building'],
                 mechanics : ['Area Movement', 'Dice Rolling', 'Variable Player Powers']
                ],
                [name      : 'Fresco', minPlayers: 2, maxPlayers: 4, averageDuration: 60, rating: 5.6,
                 family    : true,
                 strategy  : true,
                ...
                [name      : 'Flash Point: Fire Rescue', minPlayers: 1, maxPlayers: 6, averageDuration: 45, rating: 5.6,
                 family    : true,
                 thematic  : true,
                ...
                [name      : 'Lost Cities', minPlayers: 2, maxPlayers: 2, averageDuration: 30, rating: 5.4,
                 family    : true,
                 categories: ['Card Game', 'Exploration'],
                 mechanics : ['Hand Management', 'Set Collection']
                ],
                [name      : 'Vikings', minPlayers: 2, maxPlayers: 4, averageDuration: 60, rating: 5.6,
                 strategy  : true,
                 categories: ['Economic', 'Medieval', 'Nautical', 'Territory Building'],
                 mechanics : ['Auction/Bidding', 'Tile Placement']
                ],
                [name      : 'Space Hulk', minPlayers: 2, maxPlayers: 4, averageDuration: 45, rating: 6.0,
                 thematic  : true,
                ...
                [name      : 'Runebound', minPlayers: 2, maxPlayers: 4, averageDuration: 150, rating: 6.2,
                 thematic  : true,
                 categories: ['Adventure', 'Exploration', 'Fantasy'],
                 mechanics : ['Deck/Pool Building', 'Dice Rolling', 'Variable Player Powers']
                ],
                [name      : 'Last Night on Earth: The Zombie Game', minPlayers: 2, maxPlayers: 6, averageDuration: 90, rating: 5.0,
                 thematic  : true,
                ...
                [name      : 'Thunder Alley', minPlayers: 2, maxPlayers: 7, averageDuration: 90, rating: 5.8,
                 thematic  : true,
                 categories: ['Racing', 'Sports'],
                 mechanics : ['Hand Management']
                ],
                [name      : 'Incan Gold', minPlayers: 3, maxPlayers: 8, averageDuration: 20, rating: 4.8,
                 family    : true,
                 categories: ['Adventure', 'Bluffing', 'Exploration'],
                 mechanics : ['Press Your Luck', 'Simultaneous Action Selection']
                ],
                [name      : "Witch's Brew", minPlayers: 3, maxPlayers: 5, averageDuration: 45, rating: 5.0,
                 family    : true,
                 strategy  : true,
                 categories: ['Bluffing', 'Card Game', 'Fantasy'],
                 mechanics : ['Hand Management', 'Simultaneous Action Selection']
                ],
                [name      : 'Tournay', minPlayers: 2, maxPlayers: 4, averageDuration: 45, rating: 5.2,
                 strategy  : true,
                 categories: ['Card Game', 'City Building', 'Economic', 'Medieval'],
                 mechanics : ['Card Drafting', 'Hand Management', 'Worker Placement']
                ],
                [name      : 'Amyitis', minPlayers: 2, maxPlayers: 4, averageDuration: 90, rating: 5.0,
                 strategy  : true,
                 categories: ['Ancient'],
                 mechanics : ['Area Control/Area Influence']
                ],
                [name      : 'Coup: Rebellion G54', minPlayers: 3, maxPlayers: 6, averageDuration: 15, rating: 5.4,
                 party     : true,
                 strategy  : true,
                ...
                [name      : 'Havana', minPlayers: 2, maxPlayers: 4, averageDuration: 45, rating: 4.8,
                 family    : true,
                 strategy  : true,
                 categories: ['Bluffing', 'Card Game'],
                 mechanics : ['Hand Management', 'Memory', 'Set Collection', 'Simultaneous Action Selection']
                ],
                [name      : 'Dead Men Tell No Tales', minPlayers: 2, maxPlayers: 5, averageDuration: 75, rating: 5.4,
                 thematic  : true,
                 strategy  : true,
                ...
                [name      : "Odin's Ravens", minPlayers: 2, maxPlayers: 2, averageDuration: 30, rating: 4.4,
                 family    : true,
                 strategy  : true,
                 categories: ['Animals', 'Card Game', 'Mythology', 'Racing'],
                 mechanics : ['Hand Management']
                ],
                [name      : 'SET', minPlayers: 2, maxPlayers: 20, averageDuration: 30, rating: 4.0,
                 family    : true,
                 categories: ['Card Game', 'Puzzle', 'Real-time'],
                 mechanics : ['Pattern Recognition', 'Set Collection']
                ],
                [name      : 'Metro', minPlayers: 2, maxPlayers: 6, averageDuration: 30, rating: 3.8,
                 family    : true,
                 strategy  : true,
                 categories: ['Trains'],
        ...
        private static playerData = [
                ...
                [name   : 'Will Buck',
                 library: ["Last Night on Earth: The Zombie Game",
                           "Gloomhaven",
                           "SET",
                           "Incan Gold",
                           "Flash Point: Fire Rescue",
