...
This repository contains the worked sample app for the [Querying the Database using GORM Dynamic Finders](https://grails.apache.org/guides/querying-gorm-dynamic-finders/4/guide/index.html) guide on the Apache Grails site.
