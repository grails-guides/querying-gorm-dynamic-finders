...
[source,groovy]
----
include::initial/grails-app/services/demo/QueryService.groovy[tag=findByNull]

include::initial/grails-app/services/demo/QueryService.groovy[tag=findByNotNull]
----
...
[source,groovy]
----
include::complete/grails-app/services/demo/QueryService.groovy[tag=findByNull]

include::complete/grails-app/services/demo/QueryService.groovy[tag=findByNotNull]
----
